...
<span class="date">Today's date is <?php $date=date("jS  F Y");echo $date;?></span> <br>
	<h2><span style="font-weight:bold;text-decoration:underline;"><img src="../images/forum.jpg" style="padding:0;margin:0" height="20" width="20"/>&nbsp;Add new Faculty</span></h2>
				<form id="form1" name="submit" method="post" action="add_staff.php">
					<table  border="0" cellpadding="0" cellspacing="0" >
						...
						<tr>
							<td width="100px"><strong>Degree <span class="error"></span></strong></td>
							<td>
						...
						<tr>
							<td width="100px"><strong>Department <span class="error">*</span></strong></td>
							<td>
						...
						<tr>
							...
							<td>
								<select name="semester" id="semester" onchange="getsub(this.value)">
        ...
        <div class="sidebar">
          <div class="gadget">
			<ul class="sb_menu">
              <li class="active"><a href="frmaddstaff.php">Add Faculty</a></li>
              <li><a  href="frmViewstafflist.php">View Faculty</a></li>  
            </ul>
          </div>
        </div>
        <div class="clr"></div>
