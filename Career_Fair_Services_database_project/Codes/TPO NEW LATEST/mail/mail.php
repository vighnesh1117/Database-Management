...
$mail->Username   = "careerfairiit@gmail.com"; // SMTP account username
$mail->Password   = "vighneshprateek";        // SMTP account password
$mail->SetFrom('careerfairiit@gmail.com', 'CAREER FAIR SERVICES');
//$mail->AddReplyTo($to);
