		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="insertProfileFresher.php" enctype="multipart/form-data" method="post" >
            <table >
			 ...
			 <tr>
                <td colspan="4" style="font-size:14px;font-weight:bold;text-decoration:underline;">School Details</td>
			</tr>
			<tr>
			 ...
			 <tr>
                <td colspan="4" style="font-size:14px;font-weight:bold;text-decoration:underline;">High School Details</td>
			</tr>
			<tr>
