<ul>
   ...
   <li <?php if($n==2){ echo "class=\"active\"";}?>><a href="../TPO/frmlogin.php">Career Services Login</a></li>
   <li <?php if($n==3){ echo "class=\"active\"";}?>><a href="../Users/frmUsers.php">Student Login</a></li>
   <li <?php if($n==6){ echo "class=\"active\"";}?>><a href="../Teacher/frmTeacher.php">Faculty Login</a></li>
