        ...
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="addEngAdmissionthird.php" method="post" enctype="multipart/form-data">
			   	...
			   	<tr>
					<td >
						<select name="deyear" id="deyear" required>
							...
							<option value="BE">BACHELOR YEAR</option>
						</select>
					</td>
			...
			<table>
				<tr>
					<td style="width:380px"><span class="error">*</span><b>Year of Admission to Masters Second Year :-</b></td>
				...
				<tr>
					<td><span class="error">*</span><b>Second Year Admission Reciept No.</b></td>
					<td style="width:100px">
