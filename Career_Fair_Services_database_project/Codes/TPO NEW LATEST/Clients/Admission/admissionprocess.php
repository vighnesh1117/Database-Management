			...
			<div class="namelinks" style="padding-left:150px;width:100%">
				<div class="view_port1">
				  <div class="polling_message">
						<a href="frmAdmission.php" class="page">Get Admission To Bachelors</a>
				  </div>
				  <div class="cylon_eye"></div>
				</div>
				<div class="view_port2">
				  <div class="polling_message">
						<a href="frmFirstEngAdmission.php" class="page">Get Admission To Masters First Year</a>
				  </div>
				  <div class="cylon_eye"></div>
				</div>
				<div class="view_port3">
				  <div class="polling_message">
						<a href="frmEngAdmission.php" class="page">Get Admission To Masters Second Year</a>
				  </div>
				  <div class="cylon_eye"></div>
				</div>
				<div class="view_port4">
				  <div class="polling_message">
						<a href="frmEngAdmissionthird.php" class="page">Get Admission To Masters Third Year</a>
				  </div>
				  <div class="cylon_eye"></div>
				</div>
				<div class="view_port5">
				  <div class="polling_message">
						<a href="frmEngAdmissionforth.php" class="page">Get Admission To Masters Last Year</a>
				  </div>
				  <div class="cylon_eye"></div>
				</div>
			</div>
