...
<div class="main">
  <div class="main_resize">
    <div class="header">
      <div class="logo">
        <h1><a href="#"><span>Career Services</span></a><small>Sahping your career</small></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <?php
        ...
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="adddiadmission2.php" method="post" >
            ...
            <table width="100%" cellpadding="10px" style="padding:0 50px;margin:10px;font-size:18px;font-family:normal">
				...
				<tr>
					<td>3. I undertake and bind my self to pay all dues within due date on behalf of my ward such as fees,
						charges and due as levied by the authorities from time to time</td>
				</tr>
				<tr>
			...
			<table width="100%" cellpadding="10px" style="padding:0 50px;margin:10px;font-size:18px;font-family:normal">
				<tr>
					<td>1. I hereby solemnly declare that I have read and understood all the rule of admission to the Bachelors 
				...
				<tr>
					<td>5. I hereby agree to confirm to any rules acts and laws onforeed by the US Government and I hereby 
				...
				<tr>
					<td>6. I have carefully noted the contents of the notification made regarding the five attempts rule
						of Department of Homeland Security as per RA-4 displayed on the notice board and agree to abide by it.</td>
				</tr>
			</table>
