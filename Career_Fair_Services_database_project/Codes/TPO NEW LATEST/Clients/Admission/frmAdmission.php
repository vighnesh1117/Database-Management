        ...
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="adddiadmission.php" method="post" enctype="multipart/form-data">
			 ...
			 <tr valign="top">
				...
				<td>
			   	...
			   	<tr>
					...
					<td>
						<input id="diclass" value="Bachelors" class="text" name="diclass"  readonly/><br>
								<span class="error">
					</td>
					<td>Year Bachelors in<span class="error">*</span></td>
					<td>
			...
			<table>
				<tr>
					<td>[2.]Social Security Number <span class="error">*</span></td>
					<td>
			...
			<table>
				<tr valign="top">
					<td>[3.]School conducted <span class="error">*</span></td>
					<td colspan="3">
				...
				<tr valign="top">
					<td>[4.]Last HighSchool/College Attended <span class="error">*</span></td>
					<td colspan="3">
				...
				<tr>
					<td>Street 1 <span class="error">*</span></td>
					<td>
