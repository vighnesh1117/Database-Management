		   ...
		   <form action="addEngAdmission1.php" method="post" >
			...
			<table border="1px">
				<tr>
					...
					<th>Passed/Passed with first class/Dn./Failure heads/Grade/Failed</th>
			...
			<table border="1px" style="width:100%">
				<tr>
					...
					<td>
						...
						<p style="padding-left:30px;font-size:15px"><b>Signature of Dean</b></p>
					</td>
				</tr>
			</table>
			<table>
