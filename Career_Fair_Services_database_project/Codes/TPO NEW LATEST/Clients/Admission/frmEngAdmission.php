        ...
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="addEngAdmission.php" method="post" enctype="multipart/form-data">
            <table>
			 <tr valign="top">
				...
				<tr>
					...
					<td><b>and signed by the candidate before submitting to the University office</b>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					<td style="width:380px"><span class="error">*</span><b>Year of Admission to Masters First Year :-</b></td>
				...
				<tr>
					<td><span class="error">*</span><b>Bachelors Admission Reciept No.</b></td>
					<td style="width:100px">
			...
			<table>
				<tr>
					<td><span class="error">*</span>Social Security Number</td>
					<td>
			...
			<table >
				<tr valign="top">
					<td><b>[4.]Last College/University Attended</b><span class="error">*</span></td>
					<td colspan="3">
				...
				<tr>
					...
					<td>Street 2<span class="error">*</span></td>
					<td>
				...
				<tr>
					<td>Phone. No.: <span class="error">*</span></td>
					<td>
				...
				<tr>
					...
					<td>Income $ <span class="error">*</span></td>
					<td>
