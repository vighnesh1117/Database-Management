		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
		   ...
		   <form action="adddiadmission1.php" method="post" >
			...
			<table style="padding:15px 10px;">
				<tr valign="top">
					<th colspan="3">School (Class 10th)</th>
					<th colspan="4">Junior College (Class 12th)(If passed)</th>
				 </tr>
				<tr>
					<th>Examination</th>
					<th >Maximum Marks</th>
				...
				<tr>
					<td>Vocational/Technical/Electives</td>
			...
			<table width="100%" style="margin:10px;font-size:17px;font-family:normal">
				<tr>
					<td>[9.]Whether passed with Technical/Vocation/Elective Subject in SSC exam</td>
				...
				<tr>
					<td>[10.]Whether passed Junoir college Science Exam with Vocational/Technical/Elective Subject</td>
					<td style="float:right;">
						<Select name="HSCVT">
							<option>YES</option>
							<option>NO</option>
				...
				<tr>
					<td>[11.]Whether passed junior College with MCVC </td>
					<td style="float:right;">
						<Select name="HSCMCVC">
							<option>YES</option>
							<option>NO</option>
				...
				<tr>
					<td>[13.]Whether there is any gap in studies after School (Class 10th) </td>
					<td style="float:right;">
						<Select name="GAP">
							<option>YES</option>
							<option>NO</option>
			...
			<table width="100%" style="margin:10px;font-size:17px;font-family:normal">
				<tr>
					<td>[1.]I have passed School (Class 10th) from the school located in the United States of America </td>
					<td>
						<Select name="LOCATED">
							<option>YES</option>
							<option>NO</option>
				...
				<tr>
					<td>[2.]I have passed School (Class 10th) from </td>
					<td>
						<Select name="FROM">
				...
				<tr>
					<td>[3.]If passed School from outside USA. whether father is domiciled in USA 
						if father is working in US Govt. undertaking as employee and</td>
					<td>
						<Select name="WORK">
							<option>YES</option>
							<option>NO</option>
				...
				<tr>
					<td>[4.]Transferred to USA within preciding to Academic years</td>
					<td>
				...
				<div style="margin:25px;width:100%;font-family:normal;font-size:18px;">
					<div style="width:100%">I have read carefully the rules and regulation laid by the Department of Homeland Security (USA)</div>
					<div style="width:100%">for the admission to the Examination conducted by the University. I undertake the responsibility if i fail to fulfill any of</div>
					<div style="width:100%">the conditions mentioned in the rules and regulation. I accept any and will to obide by action taken by the Computent</div>
					<div style="width:100%">authority as per the Department of Homeland Security norms.I will be solely responsible for any loss of the year, or and loss of the fees paid or</div>
