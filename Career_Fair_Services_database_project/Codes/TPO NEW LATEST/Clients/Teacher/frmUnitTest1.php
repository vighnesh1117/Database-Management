	...
	<form action="insertmarks.php" method="post">
		  ...
		  <div style="padding-top:10px">
				...
				<select id="branch" name="branch" onchange="getdata1(this.value)">
					<option>--Select Branch/Department--</option>
				</select>
		  ...
		  <div style="padding-top:10px">
				...
				<label style="padding-left:50px;">Select Class Test</label>
				<select id="test" name="test" onchange="gettable()">
					<option>--Select Class Test--</option>
					<option value="UT1">QUIZ</option>
					<option value="UT2">MID TERM</option>
				</select>
		  </div>
		  <div>
